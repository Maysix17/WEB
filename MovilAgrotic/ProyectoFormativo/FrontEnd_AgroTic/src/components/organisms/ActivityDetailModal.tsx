...
import { getReservationsByActivity, confirmUsage, deleteActividad } from '../../services/actividadesService';
                ...
                <CustomButton
                  ...
                  onClick={async () => {
                    ...
                    if (!hasDeletePermission) {
                      Swal.fire({
                        title: 'Sin Permisos',
                        text: 'No tienes permisos para eliminar actividades.',
                        icon: 'warning',
                        confirmButtonText: 'Aceptar'
                      });
                      return;
                    ...
                    if (result.isConfirmed) {
                      try {
                        await deleteActividad(activity!.id);
                        Swal.fire({
                          title: '¡Eliminado!',
                        ...
                        Swal.fire({
                          title: 'Error',
                          text: 'Error al eliminar la actividad. Inténtalo nuevamente.',
                          icon: 'error',
                          confirmButtonText: 'Aceptar'
                        });
                      }
